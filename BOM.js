...
const visitbutto=document.getElementById("visit-button");

visitbutto.addEventListener("click",function(){


    location.assign("https://www.linkedin.com/in/sijan-shariar/");
});
